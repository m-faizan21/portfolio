      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Mohd Faizan — a software engineer specializing in
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <AnimatedBorderButton >
                <a href="/Mohd_Faizan_Resume.pdf" download className="flex items-center gap-2 w-full h-full">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                {icon: Github,href:"https://github.com/m-faizan21"}, 
                {icon: Linkedin,href:"https://linkedin.com/in/mfaizan21"},
                {icon: Twitter,href:"https://X.com/MFaizan_21"},
              ].map((social, index)=> (
                <a key={index} href={social.href}
                className="p-2 rounded-full glass hover:bg-primary/10">{<social.icon className=" w-5 h-5"/>}</a>
              ))}
            </div>
        </div>
        ...
        <div className="relative animate-fade-in animation-delay-500">
          ...
          <div className="relative max-w-md mx-auto">
            ...
            <img src="/profile-photo.jpg" alt="Mohd Faizan" className="w-full aspect-[4/5] object-cover rounded-2xl"/>
